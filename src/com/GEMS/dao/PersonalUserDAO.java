...
import com.GEMS.entity.PersonalUser;
...
public class PersonalUserDAO extends BaseHibernateDAO {
	...
	public List findByExample(PersonalUser instance) {
		...
		try {
			List results = getSession().createCriteria("com.entity.PersonalUser").add(Example.create(instance)).list();
