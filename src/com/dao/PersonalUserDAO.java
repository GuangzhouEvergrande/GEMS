...
/**
 	* A data access object (DAO) providing persistence and search support for PersonalUser entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.entity.PersonalUser
  * @author MyEclipse Persistence Tools 
 */
public class PersonalUserDAO extends BaseDao  {
    ...
    public PersonalUser findById( java.lang.String id) {
        ...
        try {
            PersonalUser instance = (PersonalUser) getSession().get("com.entity.PersonalUser", id);
            hqlCommit();
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(PersonalUser instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.entity.PersonalUser")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding PersonalUser instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from PersonalUser as model where model." 
         						+ propertyName + "= ?";
    ...
    public PersonalUser merge(PersonalUser detachedInstance) {
        ...
        try {
            PersonalUser result = (PersonalUser) getSession()
	...
	public void hqlBegin() {

		session = HibernateSessionFactory.getSession();
		transaction = session.beginTransaction();
	}

	public void hqlCommit() {
		transaction.commit();
		session.close();
	}
}